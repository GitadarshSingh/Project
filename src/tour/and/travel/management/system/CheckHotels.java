...
public class CheckHotels extends JFrame implements Runnable {
    ...
    public void run(){
        ...
        String[] text = new String[]{"JW Marriott Hotel", "Madarin Oriental Hotel", "Four Seasons Hotels","Raddisson Blue Hotel",
                "Classsio Hotel", "The Bay Club Hotel","Breeze blow Hotel", "The Taj Hotel",
